...
@Composable
fun DiaperDeleteScreen(
    onNavigateBack: () -> Unit,
    onDeleteSuccess: () -> Unit,
    viewModel: DiaperDeleteViewModel = hiltViewModel(),
) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Delete diaper change") },
                navigationIcon = {
        ...
        Column(
            ...
            Text("Are you sure you want to delete this diaper change?")
