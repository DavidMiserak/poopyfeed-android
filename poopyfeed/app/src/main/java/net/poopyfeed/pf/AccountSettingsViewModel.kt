...
class AccountSettingsViewModel(
    ...
    private val allTimezones: List<String> by lazy {
        ...
        viewModelScope.launch {
            ...
            when (val result = authRepository.getProfile()) {
                is ApiResult.Success -> {
                    ...
                    _uiState.value = AccountSettingsUiState.Ready(
                        profile = profile,
                ...
                is ApiResult.Error -> {
                    ...
                    if (error is ApiError.HttpError && error.statusCode == 401) {
                        ...
                        _uiState.value =
                            AccountSettingsUiState.Error(error.getUserMessage())
                    }
                }
    ...
    fun saveProfile(
        ...
        viewModelScope.launch {
            ...
            when (val result = authRepository.updateProfile(update)) {
                ...
                is ApiResult.Error -> {
                    _uiState.value =
                        AccountSettingsUiState.Error(result.error.getUserMessage())
                }
