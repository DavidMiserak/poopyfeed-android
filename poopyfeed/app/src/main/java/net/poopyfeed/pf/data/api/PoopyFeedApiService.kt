 ...
 *
 * All endpoints use suspend functions for coroutine-based async operations.
 * Token authentication is added via OkHttp interceptor.
 */
interface PoopyFeedApiService {
    ...
    /**
     * Get paginated list of all children for current user.
     * GET /api/v1/children/
     */
    @GET("children/")
    suspend fun listChildren(
        @Query("page") page: Int = 1
    ): PaginatedResponse<Child>
    ...
    suspend fun getChild(@Path("childId") childId: Int): Child
     ...
     */
    @POST("children/")
    suspend fun createChild(@Body request: CreateChildRequest): Child
    ...
    suspend fun deleteChild(@Path("childId") childId: Int)
    ...
    /**
     * Get paginated list of feedings for a child.
     ...
     * GET /api/v1/children/{childId}/feedings/{feedingId}/
     */
     ...
     * PATCH /api/v1/children/{childId}/feedings/{feedingId}/
     */
     ...
     * DELETE /api/v1/children/{childId}/feedings/{feedingId}/
     */
    ...
    /**
     * Get paginated list of diaper changes for a child.
    ...
    /**
     * Create a new diaper change record.
     ...
     * DELETE /api/v1/children/{childId}/diapers/{diaperId}/
     */
    ...
    /**
     * Get paginated list of naps for a child.
    ...
    /**
     * Update a nap record (e.g., set end_time).
     * PATCH /api/v1/children/{childId}/naps/{napId}/
     */
    ...
    /**
     * Delete a nap record.
     * DELETE /api/v1/children/{childId}/naps/{napId}/
     */
    ...
    /**
     * Get list of children shared with other users.
     * GET /api/v1/children/{childId}/sharing/
     */
    @GET("children/{childId}/sharing/")
    suspend fun listShares(@Path("childId") childId: Int): List<ChildShare>

    /**
     * Create a share invite for a child.
     * POST /api/v1/children/{childId}/sharing/
     */
     ...
     */
    @GET("invites/pending/")
    suspend fun getPendingInvites(): List<ShareInvite>
