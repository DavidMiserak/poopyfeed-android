...
class ChildrenRepository(
     ...
     */
    suspend fun updateChild(childId: Int, request: CreateChildRequest): ApiResult<Child> = try {
...
class NapsRepository(
    ...
    suspend fun createNap(childId: Int, request: CreateNapRequest): ApiResult<Nap> = try {
...
class SharingRepository(
    ...
    suspend fun listShares(childId: Int): ApiResult<List<ChildShare>> = try {
    ...
    suspend fun getPendingInvites(): ApiResult<List<ShareInvite>> = try {
    ...
    suspend fun acceptInvite(inviteId: Int): ApiResult<ShareInvite> = try {
